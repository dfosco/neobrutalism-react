      ...
      <form>
        <Field.Group>
          <Field.Set>
            ...
            <Field.Group>
              ...
              <div className="grid grid-cols-3 gap-4">
                <Field.Field className="col-span-2">
                ...
                <Field.Field className="col-span-1">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Field.Field>
                  <Field.Label htmlFor="checkout-7j9-exp-month-ts6">Month</Field.Label>
                  <Select.Root value={month} onValueChange={setMonth}>
                    <Select.Trigger id="checkout-7j9-exp-month-ts6">{month || "MM"}</Select.Trigger>
                    <Select.Content>
                ...
                <Field.Field>
                  ...
                  <Select.Root value={year} onValueChange={setYear}>
                    <Select.Trigger id="checkout-7j9-exp-year-f59">{year || "YYYY"}</Select.Trigger>
                    <Select.Content>
          ...
          <Field.Set>
            <Field.Group>
              <Field.Field>
                <Field.Label htmlFor="checkout-7j9-optional-comments">Comments</Field.Label>
                <Textarea
