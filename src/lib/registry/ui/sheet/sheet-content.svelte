...
<SheetPortal {...portalProps}>
	...
	>
		...
		<SheetPrimitive.Close
			class="ring-offset-background focus-visible:ring-ring focus-visible:ring-offset-2 absolute end-4 top-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus-visible:ring focus-visible:ring-offset focus-visible:outline-hidden disabled:pointer-events-none"
		>
			<XIcon class="size-4" />
